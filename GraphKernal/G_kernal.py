...
if __name__ == '__main__':
    ...
    for pair in pairfileList:
        ...
        """
        mat1=[(node,nodetupe) for node,nodetupe in _basefileGraph.adjacency_iter()]
        mat1dic=list2dic(mat1)
        mat2=[(node,nodetupe) for node,nodetupe in _targetfileGraph.adjacency_iter()]
        mat2dic=list2dic(mat2)
        g1=Graph(mat1dic)
        g2=Graph(mat2dic)
        """
